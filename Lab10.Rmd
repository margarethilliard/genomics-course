...
```{r}
# downloaded earlier using download.file("https://osf.io/td5sx/download", destfile = "pinfsc50_filtered.vcf.gz")
vcf <- read.vcfR("pinfsc50_filtered.vcf.gz")
```
```{r}
vcf
...
```{r}
plot(getPOS(vcf), myDiff$Gprimest, pch = 20, col = "blue", xlab = "", ylab = "", ylim = c(0, 1), xaxt = "n") +
...
Application written in R [@RCoreTeam] using the Shiny framework [@Chang2015]. Packages and reference material from [@Danecek2011], [@Grünwald2016], [@Hedrick2005], [@Jombart2008], [@Jost2008], [@Kamvar2015], [@Kamvar2014], [@Knaus2017], [@Luikart2003],[@Nei1973], [@Paradis2004], [Paradis2017], [@Simpson1949], and [@Wright1949].
